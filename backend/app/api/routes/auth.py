...
async def login(payload: LoginRequest, response: Response):
    ...
    try:
        session = services.auth_service.authenticate(email=payload.email, password=payload.password)
...
async def refresh(
    response: Response,
    refresh_cookie: Annotated[str | None, Cookie(alias="deepagent_refresh_token")] = None,
):
